...
train_loader = torch.load("data/04_feature/kp_train_dataloader.pt")
val_loader = torch.load("data/04_feature/kp_test_dataloader.pt")
...
class GPS(torch.nn.Module):
    def __init__(
        ...
        self.node_emb = Embedding(48, channels - pe_dim)
        self.pe_lin = Linear(20, pe_dim)
        self.pe_norm = BatchNorm1d(20)
        self.edge_emb = Embedding(16, channels)
